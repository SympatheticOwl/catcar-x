...
class VisionSystem:
    def __init__(self, model_path='detect.tflite', labels_path='coco_labels.txt'):
        # Initialize camera
        self.camera = PiCamera()
        self.camera.resolution = (640, 480)
        self.camera.framerate = 1  # 1 FPS as requested
